...
namespace Workforce.Api
{
    ...
    public interface ILocationApiAsync : IApiAccessor
    {
        ...
        /// <param name="id">The Id of the entity to delete (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteLocationAsync (Guid? id = default(Guid?));
        ...
        /// <param name="id">The Id of the entity to delete (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteLocationAsyncWithHttpInfo (Guid? id = default(Guid?));
        /// <summary>
        /// Get a specific Location from Workforce
        /// </summary>
        /// <remarks>
    ...
    public partial class LocationApi : ILocationApi
    {
        ...
        /// <param name="id">The Id of the entity to delete (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteLocationAsync (Guid? id = default(Guid?))
        {
        ...
        /// <param name="id">The Id of the entity to delete (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Workforce.Client.ApiResponse<Object>> DeleteLocationAsyncWithHttpInfo (Guid? id = default(Guid?))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/v1/Location", localVarRequestOptions, this.Configuration);
